...
```text
sitio-empresa/
├── index.html          # Página de Inicio (Eslogan, presentación y servicios destacados)
├── nosotros.html       # Página Institucional (Historia, Misión, Visión, Valores y Equipo)
├── productos.html      # Catálogo General (10 tarjetas detalladas de servicios gráficos)
├── contacto.html       # Formulario visual y datos de contacto de asesores
├── 404.html            # Pantalla personalizada de error en desarrollo
└── assets/
    ├── css/
